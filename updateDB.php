<?php
	...
	if($thisMD5==$prevMD5) {
		...
		setupTable('Invoice', "create table if not exists `Invoice` (   `id` INT unsigned not null auto_increment , primary key (`id`), `type` VARCHAR(40) null default 'Quote' , `number` INT not null , `Date` DATE null , `Title` INT unsigned null , `Customer` INT unsigned not null , `Phone` INT unsigned null , `Email` INT unsigned null , `Address` INT unsigned null , `City` INT unsigned null , `Country` INT unsigned null , `PaymentStatus` VARCHAR(40) null default 'UNPAID' , `AmountDUE` DECIMAL(10,2) null , `AmountPAID` DECIMAL(10,2) null , `Balance` DECIMAL(10,2) null , `Status` VARCHAR(40) null default 'OPEN' , `tax` VARCHAR(40) null , `Total` VARCHAR(40) null , `usrAdd` VARCHAR(40) null , `whenAdd` VARCHAR(40) null , `usrUpdated` VARCHAR(40) null , `whenUpdated` VARCHAR(40) null , `related` INT unsigned null ) CHARSET utf8", $silent);
		setupIndexes('Invoice', array('Customer','related'));
		setupTable('InvoiceDetails', "create table if not exists `InvoiceDetails` (   `id` INT unsigned not null auto_increment , primary key (`id`), `invoice` INT unsigned null , `order` INT null , `product` INT unsigned null , `qty` DECIMAL(10,2) not null , `itemSale` INT unsigned null , `SubTotal` VARCHAR(40) null ) CHARSET utf8", $silent);
		setupIndexes('InvoiceDetails', array('invoice','product'));
		setupTable('Products', "create table if not exists `Products` (   `id` INT unsigned not null auto_increment , primary key (`id`), `code` VARCHAR(40) null , `item` VARCHAR(40) null , `cost` DECIMAL(10,2) null , `profit` DECIMAL(10,2) null , `itemSale` DECIMAL(10,2) null , `uploads` VARCHAR(40) null ) CHARSET utf8", $silent);
		...
		setupTable('Payroll', "create table if not exists `Payroll` (   `id` INT unsigned not null auto_increment , primary key (`id`), `employee` INT unsigned null , `date` DATE null , `start` VARCHAR(40) null , `stop` VARCHAR(40) null , `horas` DECIMAL(10,2) null , `comment` TEXT null , `value` VARCHAR(40) null , `status` VARCHAR(40) null default 'UNPAID' ) CHARSET utf8", $silent, array( "ALTER TABLE Payroll ADD `field9` VARCHAR(40)","ALTER TABLE `Payroll` CHANGE `field9` `status` VARCHAR(40) null "," ALTER TABLE `Payroll` CHANGE `status` `status` VARCHAR(40) null default 'UNPAID' "));
		...
		setupTable('Accounting', "create table if not exists `Accounting` (   `id` INT unsigned not null auto_increment , primary key (`id`), `invoice` INT unsigned null , `date` DATE null , `description` TEXT null , `account_plan` INT unsigned null , `master_account` INT unsigned null , `account` INT unsigned null , `sub_account` INT unsigned null , `type` INT unsigned null , `amount` DECIMAL(10,2) null , `balance` DECIMAL(10,2) null , `status` VARCHAR(40) null default 'OPEN' ) CHARSET utf8", $silent);
		setupIndexes('Accounting', array('invoice','account_plan'));
		setupTable('AccountPlan', "create table if not exists `AccountPlan` (   `id` INT unsigned not null auto_increment , primary key (`id`), `description` TEXT not null , `code` VARCHAR(40) not null , `master_account` INT unsigned not null , `account` INT unsigned not null , `sub_account` INT unsigned not null , `type` INT unsigned not null ) CHARSET utf8", $silent);
		setupIndexes('AccountPlan', array('master_account','account','sub_account','type'));
		setupTable('MasterAccount', "create table if not exists `MasterAccount` (   `id` INT unsigned not null auto_increment , primary key (`id`), `masterAccount` VARCHAR(40) null , `code` VARCHAR(40) null ) CHARSET utf8", $silent);
		setupTable('Account', "create table if not exists `Account` (   `id` INT unsigned not null auto_increment , primary key (`id`), `Account` VARCHAR(40) null , `code` VARCHAR(40) null ) CHARSET utf8", $silent);
		setupTable('SubAccount', "create table if not exists `SubAccount` (   `id` INT unsigned not null auto_increment , primary key (`id`), `subAccount` VARCHAR(40) null , `code` VARCHAR(40) null ) CHARSET utf8", $silent);
