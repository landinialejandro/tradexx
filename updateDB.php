<?php
	...
	if($thisMD5==$prevMD5) {
		...
		setupTable('Accounting', "create table if not exists `Accounting` (   `id` INT unsigned not null auto_increment , primary key (`id`), `invoice` INT unsigned null , `date` DATE null , `description` TEXT null , `account_plan` INT unsigned null , `master_acount` INT unsigned null , `account` INT unsigned null , `sub_account` INT unsigned null , `type` INT unsigned null , `amount` DECIMAL(10,2) null , `balance` DECIMAL(10,2) null ) CHARSET utf8", $silent);
		...
		setupTable('AccountPlan', "create table if not exists `AccountPlan` (   `id` INT unsigned not null auto_increment , primary key (`id`), `description` TEXT null , `code` VARCHAR(40) null , `master_account` INT unsigned null , `account` INT unsigned null , `sub_account` INT unsigned null , `type` INT unsigned null ) CHARSET utf8", $silent);
