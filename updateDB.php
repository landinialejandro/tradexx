<?php
	...
	if($thisMD5==$prevMD5) {
		...
		setupTable('MasterAccount', "create table if not exists `MasterAccount` (   `id` INT unsigned not null auto_increment , primary key (`id`), `masterAccount` VARCHAR(40) null , `code` VARCHAR(40) null ) CHARSET utf8", $silent, array( "ALTER TABLE MasterAccount ADD `field3` VARCHAR(40)","ALTER TABLE `MasterAccount` CHANGE `field3` `code` VARCHAR(40) null "));
		setupTable('Account', "create table if not exists `Account` (   `id` INT unsigned not null auto_increment , primary key (`id`), `Account` VARCHAR(40) null , `masterAccount` INT unsigned null , `code` VARCHAR(40) null ) CHARSET utf8", $silent, array( "ALTER TABLE Account ADD `field4` VARCHAR(40)","ALTER TABLE `Account` CHANGE `field4` `code` VARCHAR(40) null "));
		setupIndexes('Account', array('masterAccount'));
		setupTable('SubAccount', "create table if not exists `SubAccount` (   `id` INT unsigned not null auto_increment , primary key (`id`), `account` INT unsigned null , `subAccount` VARCHAR(40) null , `code` VARCHAR(40) null ) CHARSET utf8", $silent, array( "ALTER TABLE SubAccount ADD `field4` VARCHAR(40)","ALTER TABLE `SubAccount` CHANGE `field4` `code` VARCHAR(40) null "));
