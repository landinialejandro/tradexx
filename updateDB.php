<?php
	...
	if($thisMD5==$prevMD5) {
		...
		setupTable('Products', "create table if not exists `Products` (   `id` INT unsigned not null auto_increment , primary key (`id`), `code` VARCHAR(40) null , `item` VARCHAR(40) null , `cost` DECIMAL(10,2) null , `profit` DECIMAL(10,2) null , `itemSale` DECIMAL(10,2) null , `uploads` TEXT null ) CHARSET utf8", $silent);
