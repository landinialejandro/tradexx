<?php
	...
	if($thisMD5==$prevMD5) {
		...
		setupTable('Invoice', "create table if not exists `Invoice` (   `id` INT unsigned not null auto_increment , primary key (`id`), `type` VARCHAR(40) null default 'Quote' , `number` INT not null , `Date` DATE null , `Title` INT unsigned null , `Customer` INT unsigned null , `Phone` INT unsigned null , `Email` INT unsigned null , `Address` INT unsigned null , `City` INT unsigned null , `Country` INT unsigned null , `PaymentStatus` VARCHAR(40) null default 'UNPAID' , `AmountDUE` DECIMAL(10,2) null , `AmountPAID` DECIMAL(10,2) null , `Balance` DECIMAL(10,2) null , `Status` VARCHAR(40) null default 'OPEN' , `tax` VARCHAR(40) null , `Total` VARCHAR(40) null , `usrAdd` VARCHAR(40) null , `whenAdd` VARCHAR(40) null , `usrUpdated` VARCHAR(40) null , `whenUpdated` VARCHAR(40) null , `realted` INT unsigned null ) CHARSET utf8", $silent, array( "ALTER TABLE Invoice ADD `field21` VARCHAR(40)","ALTER TABLE `Invoice` CHANGE `field21` `number` VARCHAR(40) null "," ALTER TABLE `Invoice` CHANGE `number` `number` INT null "," ALTER TABLE `Invoice` CHANGE `number` `number` INT not null ","ALTER TABLE Invoice ADD `field22` VARCHAR(40)","ALTER TABLE `Invoice` CHANGE `field22` `type` VARCHAR(40) null "," ALTER TABLE `Invoice` CHANGE `type` `type` VARCHAR(40) null default 'Proform' "," ALTER TABLE `Invoice` CHANGE `number` `number` INT null "," ALTER TABLE `Invoice` CHANGE `number` `number` INT not null "," ALTER TABLE `Invoice` CHANGE `type` `type` VARCHAR(40) null default 'Quote' ","ALTER TABLE Invoice ADD `field23` VARCHAR(40)","ALTER TABLE `Invoice` CHANGE `field23` `realted` VARCHAR(40) null "));
		setupIndexes('Invoice', array('Customer','realted'));
		...
		setupTable('Accounting', "create table if not exists `Accounting` (   `id` INT unsigned not null auto_increment , primary key (`id`), `invoice` INT unsigned null , `date` DATE null , `description` TEXT null , `master_acount` INT unsigned null , `account` INT unsigned null , `sub_account` INT unsigned null , `type` INT unsigned null , `amount` DECIMAL(10,2) null , `balance` DECIMAL(10,2) null ) CHARSET utf8", $silent, array( "ALTER TABLE Accounting ADD `field10` VARCHAR(40)","ALTER TABLE `Accounting` CHANGE `field10` `invoice` VARCHAR(40) null "));
