<?php
	...
	if($thisMD5==$prevMD5) {
		...
		setupTable('Products', "create table if not exists `Products` (   `id` INT unsigned not null auto_increment , primary key (`id`), `code` VARCHAR(40) null , `item` VARCHAR(40) null , `cost` DECIMAL(10,2) null , `profit` DECIMAL(10,2) null , `itemSale` DECIMAL(10,2) null , `uploads` TEXT null ) CHARSET utf8", $silent, array( " ALTER TABLE `Products` CHANGE `uploads` `uploads` TEXT null "));
		...
		setupTable('Payroll', "create table if not exists `Payroll` (   `id` INT unsigned not null auto_increment , primary key (`id`), `employee` INT unsigned null , `date` DATE null , `start` VARCHAR(40) null , `stop` VARCHAR(40) null , `horas` DECIMAL(10,2) null , `comment` TEXT null , `value` VARCHAR(40) null , `status` VARCHAR(40) null default 'UNPAID' ) CHARSET utf8", $silent);
