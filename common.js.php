<?php
	...
	if(function_exists('date_default_timezone_set')) @date_default_timezone_set('America/Panama');
...
function Retention_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Alert_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function CustomerClass_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
...
function City_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Warehouse_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Tracking_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Status_validateData() {
	$j('.has-error').removeClass('has-error');
	/* Field FreightType can't be empty */
	if($j('#FreightType').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Freight Type", close: function() { /* */ $j('[name=FreightType]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
...
function WHJournal_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function CRM_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Payroll_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Brand_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Model_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function System_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Part_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function DatabaseAUTO_validateData() {
	$j('.has-error').removeClass('has-error');
	/* Picture field file type and size check */
	if($j('#Picture').val() != '') {
		if(!AppGini.checkFileUpload('Picture', 'jpg|jpeg|gif|png', 512000)) return false;
	}

	return true;
}
function GeneralDB_validateData() {
	$j('.has-error').removeClass('has-error');
	/* photo field file type and size check */
	if($j('#photo').val() != '') {
		if(!AppGini.checkFileUpload('photo', 'jpg|jpeg|gif|png', 512000)) return false;
...
function CustomerAuto_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
...
function TrackingCenter_validateData() {
	$j('.has-error').removeClass('has-error');
	/* Field Name can't be empty */
	if($j('#Name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Customer", close: function() { /* */ $j('[name=Name]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field Tracking can't be empty */
	if($j('#Tracking').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Tracking", close: function() { /* */ $j('[name=Tracking]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
...
function Activities_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Return_validateData() {
	$j('.has-error').removeClass('has-error');
	/* Field Status can't be empty */
	if($j('#Status').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Status", close: function() { /* */ $j('[name=Status]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function Department_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Position_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function CEO_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Manager_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Supervisor_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Losses_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Subscriptions_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Accounting_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
...
function Account_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function SubAccount_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function Type_validateData() {
	$j('.has-error').removeClass('has-error');
	return true;
}
function CCJournal_validateData() {
	$j('.has-error').removeClass('has-error');
	/* Field Logged can't be empty */
	if($j('#Logged').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Logged", close: function() { /* */ $j('[name=Logged]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Photo field file type and size check */
	if($j('#Photo').val() != '') {
		if(!AppGini.checkFileUpload('Photo', 'jpg|jpeg|gif|png', 512000)) return false;
	}
...
function persist_expanded_child(id) {
	var expand_these = JSON.parse(localStorage.getItem('Tradexx.dvp_expand'));
	...
	if($j('[id=' + id + ']').hasClass('active')) {
		if(expand_these.indexOf(id) < 0) {
			...
			localStorage.setItem('Tradexx.dvp_expand', JSON.stringify(expand_these));
		}
	}else{
		if(expand_these.indexOf(id) >= 0) {
