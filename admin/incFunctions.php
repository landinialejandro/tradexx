<?php
	...
	*/
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				'Customers' => array(
					'Caption' => 'CUSTOMERS',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Customers.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'Retention' => array(
					'Caption' => 'RETENTION',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Customer.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'Alert' => array(
					...
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Warning.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'CustomerClass' => array(
					...
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Customer type.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'Staff' => array(
					'Caption' => 'STAFF',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Staff.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
				),
				'Country' => array(
				...
				'Warehouse' => array(
					'Caption' => 'WAREHOUSE',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Warehouse.png',
					'group' => $tg[1],
					'homepageShowCount' => 1
				),
				'Tracking' => array(
					'Caption' => 'TRACKING',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Tracking center 1.png',
					'group' => $tg[1],
					'homepageShowCount' => 1
				),
				'Status' => array(
					'Caption' => 'STATUS',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/status.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				'Invoice' => array(
				...
				'WHJournal' => array(
					'Caption' => 'WH JOURNAL',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/WH Journal.png',
					'group' => $tg[4],
					'homepageShowCount' => 0
				),
				'CRM' => array(
					'Caption' => 'CRM',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/CRM.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'Payroll' => array(
					'Caption' => 'PAYROLL',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Subscriptions.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
				),
				'Brand' => array(
				...
				'DatabaseAUTO' => array(
					...
					'Description' => '',
					'tableIcon' => 'resources/table_icons/vehicle 1.png',
					'group' => $tg[2],
					'homepageShowCount' => 0
				),
				'GeneralDB' => array(
				...
				'Compras' => array(
					...
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Products 1.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'TrackingCenter' => array(
					'Caption' => 'TRACKING CENTER',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Tracking center 1.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				...
				'Claim' => array(
					'Caption' => 'CLAIM',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Claim.png',
					'group' => $tg[4],
					'homepageShowCount' => 0
				),
				'Activities' => array(
				...
				'Losses' => array(
					'Caption' => 'LOSSES',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Losses.png',
					'group' => $tg[4],
					'homepageShowCount' => 0
				),
				'Subscriptions' => array(
					'Caption' => 'SUSCRIPTIONS',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Subscriptions.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				...
				'Accounting' => array(
					'Caption' => 'CASH FLOW',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Cashflow.png',
					'group' => $tg[4],
					'homepageShowCount' => 0
				),
				'AccountPlan' => array(
				...
				'CCJournal' => array(
					'Caption' => 'CC JOURNAL',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Purchase order.png',
					'group' => $tg[4],
					'homepageShowCount' => 0
				),
				'CC' => array(
	...
	if(!function_exists('getTableList')) {
		function getTableList($skip_authentication = false) {
			$arrTables = array(
				...
				'System' => 'System',
				'Part' => 'Part',
				'DatabaseAUTO' => 'CAR DATABASE',
				'GeneralDB' => 'GENERAL DATABASE',
				'CustomerAuto' => 'CUSTOMER\'S VEHICLES',
	...
	function getThumbnailSpecs($tableName, $fieldName, $view) {
		if($tableName=='Staff' && $fieldName=='Photo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='Staff' && $fieldName=='Photo' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='DatabaseAUTO' && $fieldName=='Picture' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='GeneralDB' && $fieldName=='photo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='GeneralDB' && $fieldName=='photo' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='CCJournal' && $fieldName=='Photo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='CCJournal' && $fieldName=='Photo' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		return FALSE;
	}
	########################################################################
...
WHERE `Invoice`.`id`=\'%ID%\'',
				'Total' => 'SELECT FORMAT((SUM(`InvoiceDetails`.`SubTotal`) * (1 +(IFNULL(`Invoice`.`tax`,0) / 100)) ),2) FROM `Invoice` 
...
WHERE `Products`.`id`=\'%ID%\'',
			...
			'CCJournal' => array(
				'Balance' => 'SELECT SUM(`CCJournal`.`Amount`) FROM `CCJournal` 
WHERE `CCJournal`.`id`=\'%ID%\'',
			),
			'CC' => array(
			),
			'Receivable' => array(
