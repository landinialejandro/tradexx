...
<?php /* Inserted by Landini Admin Template on 2020-09-12 02:55:03 */ ?>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title>Tradexx | <?php echo $Translation['admin area']; ?><?php echo html_attr(isset($GLOBALS['page_title']) ? " | {$GLOBALS['page_title']}" : ''); ?></title>
	...
	<body>
	<div class="admin-area container theme-slate theme-compact">
