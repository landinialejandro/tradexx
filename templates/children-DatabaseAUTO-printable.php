...
<?php $current_table = 'DatabaseAUTO'; ?>
<?php
			...
			<table class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr data-id="<?php echo html_attr($pkValue); ?>">
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][13]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][13]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo $Translation['ImageFolder'] . urlencode($record[13]); ?>" data-lightbox="DatabaseAUTO-Picture"><img src="thumbnail.php?i=<?php echo urlencode($record[13]); ?>&t=DatabaseAUTO&f=Picture&v=tv" class="img-thumbnail"></a></td>
					</tr>
					<?php } ?>
				</tbody>
				<tfoot>
