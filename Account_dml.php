...
function Account_update($selected_id) {
	...
	sql('update `Account` set       `Account`=' . (($data['Account'] !== '' && $data['Account'] !== NULL) ? "'{$data['Account']}'" : 'NULL') . ', `code`=' . (($data['code'] !== '' && $data['code'] !== NULL) ? "'{$data['code']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!='') {
		echo $o['error'];
