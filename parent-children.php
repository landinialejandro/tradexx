		...
		$pcConfig = array(
			...
			'Status' => array(
				'Invoice' => array(
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Freight <span class="hidden child-label-Status child-field-caption">(Invoice)</span>',
					'auto-close' => true,
					'display-refresh' => true,
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(3 => 'Freight', 4 => 'Dimensions', 5 => 'Real Weight', 6 => 'VWeight', 7 => 'Total', 8 => 'Freight Type', 9 => 'Delivery date', 10 => 'Delivered'),
					'display-field-names' => array(3 => 'Tracking', 4 => 'Dimensions', 5 => 'RWeight', 6 => 'VWeight', 7 => 'Total', 8 => 'FreightType', 9 => 'DeliveryDate', 10 => 'Delivered'),
					'sortable-fields' => array(0 => '`Status`.`id`', 1 => '`Tracking1`.`id`', 2 => '`Invoice1`.`id`', 3 => '`Tracking1`.`Tracking`', 4 => '`Tracking1`.`Dimensions`', 5 => '`Tracking1`.`Weight`', 6 => '`Tracking1`.`Volume`', 7 => '`Tracking1`.`Total`', 8 => 9, 9 => '`Status`.`DeliveryDate`', 10 => 11),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
					'display-page-selector' => true,
					'show-page-progress' => true,
					'template' => 'children-Status',
					'template-printable' => 'children-Status-printable',
					'query' => "SELECT `Status`.`id` as 'id', IF(    CHAR_LENGTH(`Tracking1`.`id`), CONCAT_WS('',   `Tracking1`.`id`), '') as 'TrackID', IF(    CHAR_LENGTH(`Invoice1`.`id`), CONCAT_WS('',   `Invoice1`.`id`), '') as 'Invoice', IF(    CHAR_LENGTH(`Tracking1`.`Tracking`), CONCAT_WS('',   `Tracking1`.`Tracking`), '') as 'Tracking', IF(    CHAR_LENGTH(`Tracking1`.`Dimensions`), CONCAT_WS('',   `Tracking1`.`Dimensions`), '') as 'Dimensions', IF(    CHAR_LENGTH(`Tracking1`.`Weight`), CONCAT_WS('',   `Tracking1`.`Weight`), '') as 'RWeight', IF(    CHAR_LENGTH(`Tracking1`.`Volume`), CONCAT_WS('',   `Tracking1`.`Volume`), '') as 'VWeight', IF(    CHAR_LENGTH(`Tracking1`.`Total`), CONCAT_WS('',   `Tracking1`.`Total`), '') as 'Total', `Status`.`FreightType` as 'FreightType', if(`Status`.`DeliveryDate`,date_format(`Status`.`DeliveryDate`,'%m/%d/%Y %h:%i %p'),'') as 'DeliveryDate', concat('<i class=\"glyphicon glyphicon-', if(`Status`.`Delivered`, 'check', 'unchecked'), '\"></i>') as 'Delivered' FROM `Status` LEFT JOIN `Invoice` as Invoice1 ON `Invoice1`.`id`=`Status`.`Invoice` LEFT JOIN `Tracking` as Tracking1 ON `Tracking1`.`id`=`Status`.`Tracking` "
				),
			),
			'Invoice' => array(
				'Customer' => array(
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(0 => 'ID', 1 => 'Date', 3 => 'Customer', 4 => 'Phone', 5 => 'Email', 8 => 'Country', 9 => 'Payment Status', 10 => 'Due amount', 11 => 'Amount paid', 12 => 'Balance', 13 => 'Status'),
					'display-field-names' => array(0 => 'id', 1 => 'Date', 3 => 'Customer', 4 => 'Phone', 5 => 'Email', 8 => 'Country', 9 => 'PaymentStatus', 10 => 'AmountDUE', 11 => 'AmountPAID', 12 => 'Balance', 13 => 'Status'),
					'sortable-fields' => array(0 => '`Invoice`.`id`', 1 => '`Invoice`.`Date`', 2 => '`Customers1`.`Title`', 3 => '`Customers1`.`Customer`', 4 => '`Customers1`.`Phone`', 5 => '`Customers1`.`Email`', 6 => '`Customers1`.`Address`', 7 => 8, 8 => 9, 9 => 10, 10 => '`Invoice`.`AmountDUE`', 11 => '`Invoice`.`AmountPAID`', 12 => '`Invoice`.`Balance`', 13 => 14),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
			...
			'Products' => array(
				'invoice' => array(
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Description <span class="hidden child-label-Products child-field-caption">(Invoice)</span>',
					'auto-close' => true,
					'display-refresh' => true,
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(2 => 'Product', 3 => 'Quantity', 4 => 'Total', 5 => 'Uploads'),
					'display-field-names' => array(2 => 'item', 3 => 'qty', 4 => 'total', 5 => 'uploads'),
					'sortable-fields' => array(0 => '`Products`.`id`', 1 => '`Invoice1`.`id`', 2 => 3, 3 => 4, 4 => 5, 5 => 6),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
					...
					'query' => "SELECT `Products`.`id` as 'id', IF(    CHAR_LENGTH(`Invoice1`.`id`), CONCAT_WS('',   `Invoice1`.`id`), '') as 'invoice', `Products`.`item` as 'item', `Products`.`qty` as 'qty', `Products`.`total` as 'total', `Products`.`uploads` as 'uploads' FROM `Products` LEFT JOIN `Invoice` as Invoice1 ON `Invoice1`.`id`=`Products`.`invoice` "
				),
			),
			'WHJournal' => array(
			),
