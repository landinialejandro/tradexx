...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->ColCaption = array("ID", "Type", "Number", "Date", "Customer", "Phone", "Email", "Country", "Payment Status", "Due amount", "Amount paid", "Status", "Tax", "Total", "Related");
	$x->ColFieldName = array('id', 'type', 'number', 'Date', 'Customer', 'Phone', 'Email', 'Country', 'PaymentStatus', 'AmountDUE', 'AmountPAID', 'Status', 'tax', 'Total', 'related');
	$x->ColNumber  = array(1, 2, 3, 4, 6, 7, 8, 11, 12, 13, 14, 16, 17, 18, 23);
